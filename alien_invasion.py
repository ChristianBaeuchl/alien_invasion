...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Get rid of bullets that move beyond the visible screen.
    ...
    def _update_aliens(self):
        """Check if the fleet is at an endge, then update the positions of aliens in the fleet."""
